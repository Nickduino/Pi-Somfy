...
function setupTableShutters () {
    ...
    shutterIds.sort(function(a, b) { return config.Shutters[a].toLowerCase() > config.Shutters[b].toLowerCase()}).forEach(function(shutter) {
        ...
        var cell = '<div class="shutterRemote" name="'+shutter+'">' +
                        ...
                        '<a class="up" title="Up" data-toggle="tooltip" role="button"><svg viewBox="0 0 80 70" xmlns="http://www.w3.org/2000/svg"><path d="M35 14 Q40 0, 45 14 C55 30, 67 52, 71 60 Q75 68, 64 68 L16 68 Q5 68, 9 60 C13 52, 25 30, 35 14 Z" fill="#b0afa8"/></svg></a>' +
                        '<a class="stop" title="Stop / My" data-toggle="tooltip" role="button"><svg viewBox="0 0 86 32" xmlns="http://www.w3.org/2000/svg"><rect x="0" y="0" width="86" height="32" rx="16" fill="#b0afa8"/></svg></a>' +
                        '<a class="down" title="Down" data-toggle="tooltip" role="button"><svg viewBox="0 0 80 70" xmlns="http://www.w3.org/2000/svg"><path d="M9 10 Q5 2, 16 2 L64 2 Q75 2, 71 10 C67 18, 55 40, 45 56 Q40 70, 35 56 C25 40, 13 18, 9 10 Z" fill="#b0afa8"/></svg></a>' +
                  '</div>';
